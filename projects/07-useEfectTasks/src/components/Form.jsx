...
export const Form = ({isModalVisible, closeModal, newTask, isEdit, sendId}) => {
        ...
        <div className={`modal ${isModalVisible ? "is-active" : ""}`} >
          ...
          <div className="modal-card">
            <header className="modal-card-head">
              <h3 className="modal-card-title">görevi güncelle</h3>
            </header>
            ...
            <section className="modal-card-body">
              <form onSubmit={handleSubmitForm}>
                ...
                <div className="field">
                  <label className="label">görev başlığını güncelle</label>
                ...
                <div className="field">
                  <label className="label">görev detaylarını güncelle</label>
                  <div className="control">
            ...
            <footer className="modal-card-foot">
              <div className="buttons">
                <button className="button is-link" onClick={handleUpdate}>güncelle</button>
